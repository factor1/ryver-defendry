...
<<<<<<< HEAD
    version      = '1.4.32'; // updated with gulp version task
=======
    version      = '1.4.28'; // updated with gulp version task
>>>>>>> develop
...
var phpFiles     = ['./**/*.php', './*.php'],
    ...
    concatFiles  = [
      ...
      './node_modules/tilt/dest/tilt.jquery.js',
    ...
    url          = 'iotalk/'; // See https://browsersync.io/docs/options/#option-proxy
